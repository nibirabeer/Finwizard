...
const LoggedNavbar = ({ user }) => {
  ...
  const [profileIconUrl, setProfileIconUrl] = useState('/default-profile.png');
    ...
    const fetchProfileData = async () => {
      if (user) {
        ...
        if (userDoc.exists()) {
          ...
          setUserData(data);
          setProfileIconUrl(data.profileIcon || '/default-profile.png');
          setEditData(data);
      ...
      <div className="button-container">
        ...
        {userData.plan === 'premium' && (
          <button className="monthly-planner-button" onClick={handleMonthlyPlannerClick}>
            <span className="monthly-planner-button-text">
              <img src="/t.png" alt="Monthly Planner" className="button-icon" />
              Tools
            </span>
          </button>
        )}
        ...
        <button className="gradient-button" onClick={handleDashboardClick}>
          <span className="button-text">
            <img src="/d.png" alt="Dashboard" className="gradient-button-icon" />
            Dashboard
          </span>
        </button>
