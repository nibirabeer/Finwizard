    ...
    <div className="dashboard">
      <header className="dashboard-header">
        ...
        <button className="back-button" onClick={() => navigate(-1)}>
          <img src="/bb.png" alt="Back" style={{ width: 18, height: 18 }} />
          <span>Back</span>
        </button>
      ...
      <div className="finance-overview">
        <div className="card">
          <h2><img src="/inc.png" alt="Logo1" /> Income</h2>
          <p>£{userData.income || 0}</p>
        </div>
        <div className="card">
          <h2><img src="/exp.png" alt="Logo2" /> Expenses</h2>
          <p>£{userData.expenses || 0}</p>
        </div>
        <div className="card">
          <h2><img src="/sav.png" alt="Logo3" /> Savings</h2>
          <p>£{userData.savings || 0}</p>
        </div>
        <div className="card">
          <h2><img src="/net.png" alt="Logo4" /> Net Worth</h2>
          <p>£{netWorth}</p>
        </div>
        <div className="card">
          <h2><img src="/inv.png" alt="Logo5" /> Investments</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 p-6">
        ...
        <div className="chart-container rounded-lg shadow-lg p-6">
          ...
          <div className="net-worth-status">
            {netWorth >= 1000 ? (
              <img src="/Black Girl Love GIF by BDHCollective.gif" alt="High Net Worth" />
            ) : netWorth >= 100 ? (
              <img src="/Black Girl Queen GIF by BDHCollective.gif" alt="Medium Net Worth" />
            ) : netWorth >= 0 ? (
              <img src="/Black Girl Slow Clap GIF by BDHCollective.gif" alt="Low Net Worth" />
            ) : netWorth >= -100 ? (
              <img src="/No Way Queen GIF by BDHCollective.gif" alt="Negative Net Worth" />
            ) : (
              <img src="/No Way What GIF by BDHCollective.gif" alt="Very Negative Net Worth" />
            )}
          </div>
        </div>
      </div>

      <div className="ai-suggestion" style={{ margin: '0 0 24px' }}>
        <h3>
          <img src="/ai.png" alt="AI" style={{ width: 18, height: 18, objectFit: 'contain' }} />
          AI Suggestion
        </h3>
        <p>{aiSuggestion || "Fetching AI suggestion..."}</p>
      </div>
      ...
      >
        <img src="/c.png" alt="chat" className="w-7 h-7" />
        <span>Chat</span>
      </button>
